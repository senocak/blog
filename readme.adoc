...
|link:spring-security-annotations.adoc[Spring Security Annotations]|Bu annotation'ları kullanarak, uygulamanın kaynaklarına kimlerin erişebileceğini ve bu kaynaklarla nasıl etkileşimde bulunabileceklerini kontrol edebiliriz.
|link:entity-listenerda-beanlere-erismek.adoc[entity-listenerda-beanlere-erismek]|entity-listenerda-beanlere-erismek|Entity Listener'da Bean'lere erişmek
|===